...
## v14 mobile header fix

Исправлена мобильная шапка:

- меню больше не занимает пол-экрана сразу
- добавлена кнопка-бургер
...
## v16 mobile sanity fix

- убрана нижняя липкая CTA-панель
